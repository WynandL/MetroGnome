...
val EARN_RULES: List<EarnRule> = listOf(
    ...
    EarnRule(
        label         = "Rhythm Game",
        description   = "Earned from your in-game score - every ${PointsConfig.GAME_SCORE_DIVISOR} points = 1 Beat",
        iconKey       = "game",
        pointsPerUnit = 1,
    ...
    EarnRule(
        label         = "Mic Accuracy",
        description   = "Bonus earned when the speed trainer mic detects you're playing in time",
        iconKey       = "speed",
        pointsPerUnit = PointsConfig.MIC_ACCURACY_BONUS_PER_SESSION,
        rateUnit      = "session",
        dailyLimit    = PointsLimits.MIC_ACCURACY_SESSIONS_PER_DAY,
        limitUnit     = "sessions",
        hidden        = true,
    ),
    EarnRule(
