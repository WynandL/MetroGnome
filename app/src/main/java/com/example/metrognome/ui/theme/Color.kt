...
val PurpleGrey80 = Color(0xFF8A7DB0)
val Pink80 = Color(0xFFE8A878)

val Purple40 = Color(0xFF7B4DB0)
val PurpleGrey40 = Color(0xFF4A4070)
val Pink40 = Color(0xFF9A5A38)
...
object GnomeColors {
    ...
    val hatBrim = Color(0xFF6A0A0A)  // deep dark-red brim shadow
    val hatBand = Color(0xFF440606)  // very dark red band
    val hatGold = Color(0xFFFFD700)
